        ...
        <div class="justify-center bg-white mt-[125px] ml-[275px] mr-[20px] h-[585px] rounded-xl shadow-lg grid grid-cols-2">
            <div class="my-auto text-black text-center text-3xl font-sans font-bold">
                    <h2> Update Project </h2>
                        <form action="{{ route('admin.history.updateproject.save') }}" method="post" enctype="multipart/form-data" class="max-w-sm mx-auto">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="Id" value="{{ $history['Id'] }}"> 
                            ...
                            <div class="mt-3 mb-10">
                                <input type="file" name="Document" class="w-full text-gray-400 font-bold text-sm bg-white border file:cursor-pointer rounded-lg
                                    cursor-pointer file:border-0 file:py-3 file:px-4 file:mr-4 file:bg-gray-100 file:hover:bg-gray-200 file:text-gray-500" />
                            </div>
