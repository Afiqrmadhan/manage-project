    ...
    <div class="bg-white mt-[125px] ml-[275px] mr-[20px] rounded-xl shadow-lg flex-col">
        <div>
            <div class="border border-black rounded-lg w-full">
                <form method="GET" action="{{ route('admin.history') }}" class="py-3 px-4 rounded-lg">
                        ...
                        <tbody class="text-md divide-y divide-black">
                            ...
                            <tr>
                                ...
                                <td class="text-center p-3">
                                    ...
                                    <a href="{{ route('admin.history.document', $docshistory['ProjectId']) }}" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-600
                                    ...
                                    @endforeach
                                    @else
                                    <a href="{{ route('admin.history.document', $history['ProjectId']) }}" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-600
                                            hover:text-gray-800 focus:outline-none focus:text-gray-800 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-500 dark:hover:text-gray-400
                                            dark:focus:text-gray-400">Click Here</a>
                                    @endif
                                </td>
                                <td class="text-center p-3">
                                    <a href="{{ route('admin.history.updateproject', $history['Id']) }}" type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-600
                                        hover:text-gray-800 focus:outline-none focus:text-gray-800 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-500 dark:hover:text-gray-400
                                        dark:focus:text-gray-400">Click Here</a>
                                </td>
                            </tr>
